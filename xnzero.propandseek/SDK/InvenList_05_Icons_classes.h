...
// WidgetBlueprintGeneratedClass InvenList_05_Icons.InvenList_05_Icons_C
// 0x0048 (FullSize[0x0278] - InheritedSize[0x0230])
class UInvenList_05_Icons_C : public UUserWidget
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass InvenList_05_Icons.InvenList_05_Icons_C");
		return ptr;
	}
	...
	void Construct();
	void ExecuteUbergraph_InvenList_05_Icons(int EntryPoint);
};
