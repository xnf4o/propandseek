...
{
	unsigned char                                      UnknownData_1TC8[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FLevelSequenceObject
{
	...
	unsigned char                                      UnknownData_MNIK[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelSequenceSnapshotSettings
{
	...
	unsigned char                                      UnknownData_COTU[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelSequencePlayerSnapshot
{
	...
	unsigned char                                      UnknownData_ZNL3[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y8TW[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_RZPZ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_S26L[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
