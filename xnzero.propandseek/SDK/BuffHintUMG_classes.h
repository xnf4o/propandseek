...
// WidgetBlueprintGeneratedClass BuffHintUMG.BuffHintUMG_C
// 0x0018 (FullSize[0x0248] - InheritedSize[0x0230])
class UBuffHintUMG_C : public UUserWidget
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BuffHintUMG.BuffHintUMG_C");
		return ptr;
	}



	void UpdateSessionCreatorHintText(const struct FString& Content, bool OwnIt_);
};
