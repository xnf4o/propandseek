...
// BlueprintGeneratedClass TPP_Shotgun_Magazine.TPP_Shotgun_Magazine_C
// 0x0024 (FullSize[0x0354] - InheritedSize[0x0330])
class ATPP_Shotgun_Magazine_C : public AActor
{
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             OwnerSeeTiming__Direction_71F3B5E043BE4A6D88D298A724129315; // 0x0340(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_IXE6[0x7];                                     // 0x0341(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass TPP_Shotgun_Magazine.TPP_Shotgun_Magazine_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_TPP_Shotgun_Magazine(int EntryPoint);
};
