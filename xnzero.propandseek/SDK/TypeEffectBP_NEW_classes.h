...
// WidgetBlueprintGeneratedClass TypeEffectBP_NEW.TypeEffectBP_NEW_C
// 0x0018 (FullSize[0x0248] - InheritedSize[0x0230])
class UTypeEffectBP_NEW_C : public UUserWidget
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass TypeEffectBP_NEW.TypeEffectBP_NEW_C");
		return ptr;
	}
	...
	void Construct();
	void ExecuteUbergraph_TypeEffectBP_NEW(int EntryPoint);
};
