...
// WidgetBlueprintGeneratedClass SessionCreatrHintUMG.SessionCreatrHintUMG_C
// 0x0018 (FullSize[0x0248] - InheritedSize[0x0230])
class USessionCreatrHintUMG_C : public UUserWidget
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass SessionCreatrHintUMG.SessionCreatrHintUMG_C");
		return ptr;
	}
