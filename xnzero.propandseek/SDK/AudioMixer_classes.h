...
{
public:
	unsigned char                                      UnknownData_J0G6[0x8];                                     // 0x0258(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_KSQN[0x3];                                     // 0x05F1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9NJ4[0x4];                                     // 0x05FC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9O0C[0x20];                                    // 0x0610(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GV7A[0x30];                                    // 0x0640(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_YX1S[0x50];                                    // 0x0040(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_IXGQ[0x38];                                    // 0x0040(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_VFP7[0x5C];                                    // 0x0040(0x005C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_5ZMP[0x20];                                    // 0x02F0(0x0020) MISSED OFFSET (PADDING)
