...
struct FMovieSceneCaptureSettings
{
	...
	unsigned char                                      UnknownData_QJD4[0x2];                                     // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_72XF[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_F8SI[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
