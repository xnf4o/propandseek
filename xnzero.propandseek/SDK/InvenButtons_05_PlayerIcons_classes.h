...
// WidgetBlueprintGeneratedClass InvenButtons_05_PlayerIcons.InvenButtons_05_PlayerIcons_C
// 0x0060 (FullSize[0x0290] - InheritedSize[0x0230])
class UInvenButtons_05_PlayerIcons_C : public UUserWidget
{
public:
	...
	unsigned char                                      UnknownData_BZK6[0x4];                                     // 0x027C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass InvenButtons_05_PlayerIcons.InvenButtons_05_PlayerIcons_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_InvenButtons_05_PlayerIcons(int EntryPoint);
};
