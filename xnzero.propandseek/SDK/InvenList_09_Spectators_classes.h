...
// WidgetBlueprintGeneratedClass InvenList_09_Spectators.InvenList_09_Spectators_C
// 0x0048 (FullSize[0x0278] - InheritedSize[0x0230])
class UInvenList_09_Spectators_C : public UUserWidget
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass InvenList_09_Spectators.InvenList_09_Spectators_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_InvenList_09_Spectators(int EntryPoint);
};
