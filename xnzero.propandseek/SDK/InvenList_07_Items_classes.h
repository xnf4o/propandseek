...
// WidgetBlueprintGeneratedClass InvenList_07_Items.InvenList_07_Items_C
// 0x0048 (FullSize[0x0278] - InheritedSize[0x0230])
class UInvenList_07_Items_C : public UUserWidget
{
public:
	...
	int                                                SelectedIndex;                                             // 0x0274(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass InvenList_07_Items.InvenList_07_Items_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_InvenList_07_Items(int EntryPoint);
};
