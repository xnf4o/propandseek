...
// WidgetBlueprintGeneratedClass Profile_AchievementButton.Profile_AchievementButton_C
// 0x0039 (FullSize[0x0269] - InheritedSize[0x0230])
class UProfile_AchievementButton_C : public UUserWidget
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Profile_AchievementButton.Profile_AchievementButton_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Profile_AchievementButton(int EntryPoint);
};
