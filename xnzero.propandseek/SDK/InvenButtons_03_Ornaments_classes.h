...
// WidgetBlueprintGeneratedClass InvenButtons_03_Ornaments.InvenButtons_03_Ornaments_C
// 0x0060 (FullSize[0x0290] - InheritedSize[0x0230])
class UInvenButtons_03_Ornaments_C : public UUserWidget
{
public:
	...
	unsigned char                                      UnknownData_T8KI[0x4];                                     // 0x027C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass InvenButtons_03_Ornaments.InvenButtons_03_Ornaments_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_InvenButtons_03_Ornaments(int EntryPoint);
};
