...
// WidgetBlueprintGeneratedClass InvenList_06_Aliases.InvenList_06_Aliases_C
// 0x0048 (FullSize[0x0278] - InheritedSize[0x0230])
class UInvenList_06_Aliases_C : public UUserWidget
{
public:
	...
	int                                                SelectedIndex_Aliases_;                                    // 0x0270(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass InvenList_06_Aliases.InvenList_06_Aliases_C");
		return ptr;
	}
	...
	void OnParentConstructA();
	void ExecuteUbergraph_InvenList_06_Aliases(int EntryPoint);
};
