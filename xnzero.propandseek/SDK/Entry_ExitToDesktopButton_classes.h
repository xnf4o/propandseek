...
// WidgetBlueprintGeneratedClass Entry_ExitToDesktopButton.Entry_ExitToDesktopButton_C
// 0x0028 (FullSize[0x0258] - InheritedSize[0x0230])
class UEntry_ExitToDesktopButton_C : public UUserWidget
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Entry_ExitToDesktopButton.Entry_ExitToDesktopButton_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Entry_ExitToDesktopButton(int EntryPoint);
};
