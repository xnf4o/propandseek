...
// WidgetBlueprintGeneratedClass InvenList_03_Ornaments.InvenList_03_Ornaments_C
// 0x0048 (FullSize[0x0278] - InheritedSize[0x0230])
class UInvenList_03_Ornaments_C : public UUserWidget
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass InvenList_03_Ornaments.InvenList_03_Ornaments_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_InvenList_03_Ornaments(int EntryPoint);
};
