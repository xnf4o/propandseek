...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WB_Button02_HoveredShine.WB_Button02_HoveredShine_C");
		return ptr;
	}
	...
	void OnHovered(const struct FLinearColor& Color, TEnumAsByte<EJustification_EJustification> Justification);
	void OnUnhovered();
