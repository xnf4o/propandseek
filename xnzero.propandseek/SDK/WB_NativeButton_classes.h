...
public:
	...
	unsigned char                                      UnknownData_FG0J[0x7];                                     // 0x0299(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T81V[0x7];                                     // 0x02C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WB_NativeButton.WB_NativeButton_C");
		return ptr;
	}
