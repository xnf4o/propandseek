...
class UWB_Button02_FrameFX_C : public UUserWidget
{
public:
	class UBorder*                                     b_FrameColor;                                              // 0x0230(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WB_Button02_FrameFX.WB_Button02_FrameFX_C");
		return ptr;
	}
