...
public:
	...
	TEnumAsByte<EJustification_EJustification>         EJustification;                                            // 0x0298(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                               bIsClicked;                                                // 0x0299(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_IU4C[0x2];                                     // 0x029A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WB_Button02_BlurShine.WB_Button02_BlurShine_C");
		return ptr;
	}
	...
	void OnUnhovered();
	void OnClicked();
	void UpdateJustification(TEnumAsByte<EJustification_EJustification> EJustification);
