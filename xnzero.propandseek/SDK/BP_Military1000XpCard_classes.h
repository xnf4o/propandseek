...
// BlueprintGeneratedClass BP_Military1000XpCard.BP_Military1000XpCard_C
// 0x0020 (FullSize[0x0350] - InheritedSize[0x0330])
class ABP_Military1000XpCard_C : public AActor
{
public:
	class UPointLightComponent*                        PointLightBack;                                            // 0x0330(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_Military1000XpCard.BP_Military1000XpCard_C");
		return ptr;
	}
