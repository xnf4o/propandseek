...
// WidgetBlueprintGeneratedClass 02_YouEliminated.02_YouEliminated_C
// 0x0034 (FullSize[0x0264] - InheritedSize[0x0230])
class U02_YouEliminated_C : public UUserWidget
{
public:
	...
	struct FString                                     UsernameThatYouKilled;                                     // 0x0250(0x0010) (Edit, BlueprintVisible, ZeroConstructor, ExposeOnSpawn, HasGetValueTypeHash)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass 02_YouEliminated.02_YouEliminated_C");
		return ptr;
	}
	...
	void Construct();
	void ExecuteUbergraph_02_YouEliminated(int EntryPoint);
};
