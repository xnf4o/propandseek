...
// BlueprintGeneratedClass Ammo_Shotgun.Ammo_Shotgun_C
// 0x0024 (FullSize[0x0354] - InheritedSize[0x0330])
class AAmmo_Shotgun_C : public AActor
{
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             OwnerSeeTiming__Direction_FAEBFA8E46799DB01F7DF78E24567E75; // 0x0340(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_L8MD[0x7];                                     // 0x0341(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass Ammo_Shotgun.Ammo_Shotgun_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Ammo_Shotgun(int EntryPoint);
};
