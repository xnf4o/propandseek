...
struct FClothConfig
{
	...
	unsigned char                                      UnknownData_HD74[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LX4G[0x3];                                     // 0x00BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FClothLODData
{
	...
	unsigned char                                      UnknownData_UHFM[0x20];                                    // 0x00D8(0x0020) MISSED OFFSET (PADDING)
...
struct FClothParameterMask_PhysMesh
{
	...
	unsigned char                                      UnknownData_I1XQ[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EB91[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1EOR[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
