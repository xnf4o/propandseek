...
// WidgetBlueprintGeneratedClass Profile_RankingButton.Profile_RankingButton_C
// 0x0039 (FullSize[0x0269] - InheritedSize[0x0230])
class UProfile_RankingButton_C : public UUserWidget
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Profile_RankingButton.Profile_RankingButton_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Profile_RankingButton(int EntryPoint);
};
