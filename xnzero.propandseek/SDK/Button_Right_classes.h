...
// WidgetBlueprintGeneratedClass Button_Right.Button_Right_C
// 0x0040 (FullSize[0x0270] - InheritedSize[0x0230])
class UButton_Right_C : public UUserWidget
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Button_Right.Button_Right_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Button_Right(int EntryPoint);
