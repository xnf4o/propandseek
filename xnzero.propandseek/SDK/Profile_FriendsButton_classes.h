...
// WidgetBlueprintGeneratedClass Profile_FriendsButton.Profile_FriendsButton_C
// 0x0039 (FullSize[0x0269] - InheritedSize[0x0230])
class UProfile_FriendsButton_C : public UUserWidget
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Profile_FriendsButton.Profile_FriendsButton_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Profile_FriendsButton(int EntryPoint);
};
