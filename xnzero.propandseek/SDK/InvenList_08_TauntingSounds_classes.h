...
// WidgetBlueprintGeneratedClass InvenList_08_TauntingSounds.InvenList_08_TauntingSounds_C
// 0x0048 (FullSize[0x0278] - InheritedSize[0x0230])
class UInvenList_08_TauntingSounds_C : public UUserWidget
{
public:
	...
	int                                                PreviewIndex;                                              // 0x0270(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                SelectedIndex_TauntingSound_;                              // 0x0274(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass InvenList_08_TauntingSounds.InvenList_08_TauntingSounds_C");
		return ptr;
	}
	...
	void UpdateList(bool Upload_, bool SyncAsDefault);
	void GI(class UGI2_C** AsGI2);
	void OnParentConstruct();
	void ExecuteUbergraph_InvenList_08_TauntingSounds(int EntryPoint);
};
