...
// WidgetBlueprintGeneratedClass SpecUpWidget.SpecUpWidget_C
// 0x0020 (FullSize[0x0250] - InheritedSize[0x0230])
class USpecUpWidget_C : public UUserWidget
{
public:
	...
	class UVerticalBox*                                Root;                                                      // 0x0240(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass SpecUpWidget.SpecUpWidget_C");
		return ptr;
	}



	void UpdateAlias(int NewAlias);
	void UpdateUsername(const struct FString& NewUsername);
};
