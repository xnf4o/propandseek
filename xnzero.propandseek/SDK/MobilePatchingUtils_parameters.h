...
struct UMobileInstalledContent_Mount_Params
{
	...
	struct FString                                     MountPoint;                                                // 0x0000(0x0010)  (Parm, ZeroConstructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct UMobilePendingContent_StartInstall_Params
{
	...
	struct FScriptDelegate                             OnFailed;                                                  // 0x0000(0x0010)  (Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
};
...
struct UMobilePatchingLibrary_RequestContent_Params
{
	...
	struct FString                                     CloudURL;                                                  // 0x0000(0x0010)  (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
